...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl0.setGeometry(QtCore.QRect(50, 30, 111, 17))
        self.lbl0.setObjectName("lbl0")
        self.lbl1 = QtWidgets.QLabel(Dialog)
        self.lbl1.setGeometry(QtCore.QRect(50, 70, 151, 17))
        self.lbl1.setObjectName("lbl1")
        self.lbl2 = QtWidgets.QLabel(Dialog)
        self.lbl2.setGeometry(QtCore.QRect(50, 120, 101, 17))
        self.lbl2.setObjectName("lbl2")
        self.lbl3 = QtWidgets.QLabel(Dialog)
        self.lbl3.setGeometry(QtCore.QRect(50, 170, 81, 17))
        self.lbl3.setObjectName("lbl3")
        self.lbl4 = QtWidgets.QLabel(Dialog)
        self.lbl4.setGeometry(QtCore.QRect(50, 220, 81, 17))
