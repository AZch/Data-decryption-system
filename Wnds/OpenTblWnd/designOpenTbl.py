...
class Ui_openTbl(object):
    def setupUi(self, openTbl):
        ...
        openTbl.resize(842, 682)
        self.tblData = QtWidgets.QTableWidget(openTbl)
        self.tblData.setGeometry(QtCore.QRect(10, 4, 821, 431))
        ...
        self.btnUpdTbl.setGeometry(QtCore.QRect(590, 444, 111, 23))
        self.btnUpdTbl.setObjectName("btnUpdTbl")
        self.btnExit = QtWidgets.QPushButton(openTbl)
        self.btnExit.setGeometry(QtCore.QRect(710, 644, 121, 31))
        self.btnExit.setObjectName("btnExit")
        self.btnClearChgAll = QtWidgets.QPushButton(openTbl)
        self.btnClearChgAll.setGeometry(QtCore.QRect(760, 564, 71, 31))
        ...
        self.tblChgTest.setGeometry(QtCore.QRect(10, 444, 741, 191))
        ...
        self.lblMsg.setGeometry(QtCore.QRect(20, 650, 681, 21))
        self.lblMsg.setText("")
