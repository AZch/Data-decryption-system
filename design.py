...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnCalcTo.setGeometry(QtCore.QRect(1030, 580, 131, 23))
        ...
        self.btnExit.setGeometry(QtCore.QRect(940, 550, 81, 31))
        self.btnExit.setObjectName("btnExit")
        self.label_16 = QtWidgets.QLabel(self.centralwidget)
        self.label_16.setGeometry(QtCore.QRect(300, 560, 191, 21))
        self.label_16.setObjectName("label_16")
        self.lcdNumber = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcdNumber.setGeometry(QtCore.QRect(490, 560, 101, 21))
        font = QtGui.QFont()
        ...
        self.label_5.setGeometry(QtCore.QRect(10, 560, 61, 16))
        self.label_5.setObjectName("label_5")
        self.lblMsg = QtWidgets.QLabel(self.centralwidget)
        self.lblMsg.setGeometry(QtCore.QRect(80, 560, 211, 16))
        self.lblMsg.setText("")
        ...
        self.tblInutTest.setGeometry(QtCore.QRect(10, 30, 701, 311))
        ...
        self.tblRes.setGeometry(QtCore.QRect(10, 370, 1011, 171))
        ...
        self.prgExec.setGeometry(QtCore.QRect(670, 559, 261, 21))
        self.prgExec.setProperty("value", 0)
        self.prgExec.setObjectName("prgExec")
        self.label_19 = QtWidgets.QLabel(self.centralwidget)
        self.label_19.setGeometry(QtCore.QRect(600, 560, 71, 16))
        self.label_19.setObjectName("label_19")
        self.lblExecuteProc = QtWidgets.QLabel(self.centralwidget)
        self.lblExecuteProc.setGeometry(QtCore.QRect(670, 560, 231, 21))
        ...
        self.actDB = QtWidgets.QAction(MainWindow)
        self.actDB.setObjectName("actDB")
        self.actMail = QtWidgets.QAction(MainWindow)
        self.actMail.setObjectName("actMail")
        ...
        self.menuLoadInputTest.addAction(self.actLoadTest)
        self.menu_3.addSeparator()
        self.menu_3.addAction(self.actDB)
        self.menu_3.addAction(self.actMail)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuLoadInputTest.setTitle(_translate("MainWindow", "Загрузить"))
        self.menu_3.setTitle(_translate("MainWindow", "Подключение"))
        ...
        self.actDB.setText(_translate("MainWindow", "База данных"))
        self.actMail.setText(_translate("MainWindow", "Почта"))
